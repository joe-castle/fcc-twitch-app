...
/***/ function(module, exports, __webpack_require__) {
	...
	var _streamers = __webpack_require__(180);

	var _streamers2 = _interopRequireDefault(_streamers);

	var _isFetching = __webpack_require__(181);

	var _isFetching2 = _interopRequireDefault(_isFetching);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var twitchApp = (0, _redux.combineReducers)({
		streamers: _streamers2.default,
		filters: _filters2.default,
		isFetching: _isFetching2.default
	});

	exports.default = (0, _redux.createStore)(twitchApp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		...
		switch (action.type) {
			...
			case _actionTypes.SET_SEARCH_FILTER:
				return _extends({}, state, {
...
/***/ function(module, exports) {
	...
	var ADD_STREAMER = exports.ADD_STREAMER = 'ADD_STREAMER';
	var DELETE_STREAMER = exports.DELETE_STREAMER = 'DELETE_STREAMER';
	var SET_VISIBILITY_FILTER = exports.SET_VISIBILITY_FILTER = 'SET_VISIBILITY_FILTER';
	var SET_SEARCH_FILTER = exports.SET_SEARCH_FILTER = 'SET_SEARCH_FILTER';
	var SET_FETCH = exports.SET_FETCH = 'SET_FETCH';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		...
		switch (action.type) {
			case _actionTypes.ADD_STREAMER:
				return [_extends({}, action.payload)].concat(_toConsumableArray(state));
			case _actionTypes.DELETE_STREAMER:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputBox = __webpack_require__(184);

	var _inputBox2 = _interopRequireDefault(_inputBox);

	var _streamersBox = __webpack_require__(185);

	var _streamersBox2 = _interopRequireDefault(_streamersBox);
	...
	var App = function App(_ref) {
		...
		var visibleStreamers = _ref.visibleStreamers;
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(_nav2.default, {
				...
				onVisibilityClick: function onVisibilityClick(text) {
					return dispatch({ type: _actionTypes.SET_VISIBILITY_FILTER, filter: text });
				} }),
			_react2.default.createElement(_inputBox2.default, {
				onAddClick: function onAddClick(text) {
					return (0, _api2.default)(text);
				},
				onSearchChange: function onSearchChange(text) {
					return dispatch({ type: _actionTypes.SET_SEARCH_FILTER, filter: text });
				} }),
			...
			_react2.default.createElement(_streamersBox2.default, {
				streamers: visibleStreamers,
				onDeleteClick: function onDeleteClick(index) {
					return dispatch({ type: _actionTypes.DELETE_STREAMER, index: index });
				} })
		);
	};

	var selectStreamers = function selectStreamers(streamers, filters) {
		var s = streamers.filter(function (i) {
			return i.channel.name.indexOf(filters.searchFilter) > -1;
		});
		switch (filters.visibilityFilter) {
			...
			case 'SHOW_ONLINE':
				return s.filter(function (i) {
					return Boolean(i.stream.stream) === true;
				});
			case 'SHOW_OFFLINE':
				return s.filter(function (i) {
					return Boolean(i.stream.stream) === false;
				});
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
		var onVisibilityClick = _ref.onVisibilityClick;
		var visibilityFilter = _ref.visibilityFilter;
		return _react2.default.createElement(
			'nav',
			null,
			_react2.default.createElement(
				'ul',
				null,
				[['All', 'SHOW_ALL'], ['Online', 'SHOW_ONLINE'], ['Offline', 'SHOW_OFFLINE']].map(function (item, index) {
					return _react2.default.createElement(
						'li',
						{
							...
							onClick: function onClick() {
								return onVisibilityClick(item[1]);
							} },
						item[0]
					);
				})
	...
	exports.default = (0, _react.createClass)({
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ id: 'search', className: 'input-group' },
					_react2.default.createElement(
						'span',
						{ className: 'input-group-addon' },
						_react2.default.createElement('span', { className: 'glyphicon glyphicon-search' })
					),
					_react2.default.createElement('input', { onChange: this.search, type: 'text', placeholder: 'Search...', className: 'form-control' })
				),
				_react2.default.createElement(
					'div',
					{ id: 'add-streamer', className: 'input-group' },
					_react2.default.createElement(
						'span',
						{ className: 'input-group-btn' },
						_react2.default.createElement(
							'button',
							{ onClick: this.addStreamer, type: 'button', className: 'btn' },
							_react2.default.createElement('span', { className: 'glyphicon glyphicon-plus' })
						)
					),
					_react2.default.createElement('input', { ref: 'streamerInput', type: 'text', className: 'form-control', placeholder: 'Add a streamer...' })
				)
			);
		},
		addStreamer: function addStreamer() {
			var node = this.refs.streamerInput;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _streamer = __webpack_require__(186);
	...
	exports.default = function (_ref) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'ul',
				{ id: 'streamers' },
				streamers.map(function (streamer, index) {
					return _react2.default.createElement(_streamer2.default, {
						key: index,
	...
	exports.default = function (_ref) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement('span', {
				...
				className: 'delete glyphicon glyphicon-remove-circle' }),
			_react2.default.createElement('img', { src: channel.logo || 'http://placehold.it/50x50' }),
			_react2.default.createElement(
				'a',
				{ href: 'http://www.twitch.tv/' + channel.name, target: '_blank' },
				_react2.default.createElement(
					'span',
					{ className: 'name' },
			...
			_react2.default.createElement('span', { className: 'glyphicon glyphicon-' + (stream.stream ? 'ok' : 'remove') }),
			_react2.default.createElement(
				'span',
				{ className: 'status' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getStreamer = function getStreamer(streamer) {
		_root2.default.dispatch({ type: _actionTypes.SET_FETCH, fetch: true });

		var channel = fetch('https://api.twitch.tv/kraken/channels/' + streamer).then(function (res) {
			return res.json();
		});
		var stream = fetch('https://api.twitch.tv/kraken/streams/' + streamer).then(function (res) {
			return res.json();
		});

		Promise.all([channel, stream]).then(function (json) {
			if (json[0].error) {
				_root2.default.dispatch({ type: _actionTypes.SET_FETCH, fetch: false });
				console.error(json[0].message);
			} else {
				_root2.default.dispatch({ type: _actionTypes.SET_FETCH, fetch: false });
				_root2.default.dispatch({ type: _actionTypes.ADD_STREAMER, payload: { channel: json[0], stream: json[1] } });
			}
		});
	};

	var initialStreamers = ['freecodecamp', 'storbeck', 'terakilobyte', 'habathcx', 'RobotCaleb', 'thomasballinger', 'noobs2ninjas', 'beohoff', 'medrybw'];

	initialStreamers.forEach(function (streamer) {
		return getStreamer(streamer);
	});

	exports.default = getStreamer;
